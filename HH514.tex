...
\begin{abstract}
  ...
  We use high-spectral resolution spectroscopy from the UVES spectrograph
  ...
  The reduced depletion of Fe and Ni compared with the general interstellar medium
  is often observed in HH objects and is probably caused by destruction of dust grains.
  HH~514 shows evidence of a greater degree of dust destruction
  than slower-moving photoionized HH objects that we have studied in previous works.
  The observed sulphur overabundance (more than two times solar)
  seems to be unique to this object and is challenging to explain
  since it occurs only in the high-velocity jet component,
  whereas the proplyd photoevaporation flow from the same disk shows normal sulphur abundance.
