...
with an estimated dust mass of \SI{23}{\mearth} \citep{Eisner:2018a}.
The disk has also been detected in the CO 3--2 line \citep{Boyden:2020a},
yielding a disk radius of \SI{44}{AU}
(the gas mass cannot be determined because the line is optically thick).
...
calculating mass loss rate of \SI{6e-7}{\msun.yr^{-1}}.
